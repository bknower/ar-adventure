...
//       this.updatePlayerLocation(this.places, position);
//     }, errorHandler);
//   }

//   updatePlayerLocation(places: Places, position: GeolocationPosition): void {
...
//     //   );
//     // });
//     this.player.location = L.latLng(
//       position.coords.latitude,
//       position.coords.longitude
//     );
//     // console.log("location updated", this.player.location);
//     Object.entries(this.places).forEach(([name, place]) => {
//       if (
//         place.location !== null &&
//         place.location.distanceTo(this.player.location) < maxDistance
//       ) {
